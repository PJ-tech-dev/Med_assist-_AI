...
def get_llm(model_name: Optional[str] = None, temperature: float = 0.2) -> Optional[BaseChatModel]:
    ...
    nvidia_key = (
        ...
        or "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"
    )
    nvidia_base = (
    ...
    nvidia_model = model_name or getattr(settings, "nvidia_model", "meta/llama3-8b-instruct")
